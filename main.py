...
from flask import send_file, Flask, render_template_string, request, redirect, url_for, session, jsonify
...
<!-- ✅ YAHAN PE btn-success PASTE KARO -->
...
<!-- ✅ YAHAN PE download-bar PASTE KARO -->
...
<div class="card">
  {% if files %}
    ...
    <div class="file-item">
      ...
      <div class="actions">
        <a href="/files/download/{{ file.name }}" class="btn btn-success btn-sm"></a> 
